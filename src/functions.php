...
function cjwsstrm_scripts() {
	wp_enqueue_style( 'cjwsstrm-style', get_stylesheet_uri() );
	...
	wp_enqueue_script( 'cjwsstrm-public', get_template_directory_uri() . '/js/cjwsstrm-public-compiled.js', array(), '20151215', true );
